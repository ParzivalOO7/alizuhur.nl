...
// 110- Deze regel declareert een functie genaamd "initTimer" waaraan een enkele parameter "maxTime" moet doorgegeven worden. 
// 111- De functie "clearInterval" wordt aangeroepen met de variabele "timer" als argument
// 117- Als de maxTime niet groter is dan 0, wordt er een waarschuwing geactiveerd. initGame functie is reseten van speelstatus.
// 120- Het hele intervalblok wordt elke 1000 milliseconden (1 seconde) uitgevoerd, waarbij de timer wordt bijgewerkt. en wordt gecontroleerd of er nog tijd over is. Dit simuleert een afteltimer voor het spel.
